...
func (c *userManagementClient) Create(ctx context.Context, in *User, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/protogo.user.UserManagement/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserManagementServer) Create(context.Context, *User) (*Response, error) {
...
func _UserManagement_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protogo.user.UserManagement/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserManagementServer).Create(ctx, req.(*User))
	}
...
var UserManagement_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protogo.user.UserManagement",
